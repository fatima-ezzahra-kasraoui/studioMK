document.addEventListener("DOMContentLoaded", function () {
  ...
  // Header scroll avec hystérésis anti-tremblement
  ...
  if (header) {
    ...
    var onScroll = function () {
      ...
      var shouldBeScrolled = headerScrolled ? y > 30 : y > 60;
